  ...
  return (
    <Layout title="Dashboard" pageId="dashboard" actions={actions}>
      <div className="metrics">
        <div className="met" style={{ '--mac': 'var(--or)', '--macd': 'var(--ord)' } as React.CSSProperties} onClick={() => navigate('/os')}>
          ...
          <div className="mico">
            <svg viewBox="0 0 24 24"><path d="M14 2H6c-1.1 0-2 .9-2 2v16h16V8z" /></svg>
          </div>
        </div>
        <div className="met" style={{ '--mac': 'var(--gn)', '--macd': 'var(--gnd)' } as React.CSSProperties} onClick={() => navigate('/os?filter=CONCLUIDO')}>
        ...
        <div className="met" style={{ '--mac': 'var(--bl)', '--macd': 'var(--bld)' } as React.CSSProperties} onClick={() => navigate('/clientes')}>
          ...
          <div className="mico">
            <svg viewBox="0 0 24 24"><path d="M16 11c1.66 0 3-1.34 3-3s-1.34-3-3-3-3 1.34-3 3 1.34 3 3 3zm-8 0c1.66 0 3-1.34 3-3S9.66 5 8 5 5 6.34 5 8s1.34 3 3 3z" /></svg>
          </div>
        </div>
        <div className="met" style={{ '--mac': 'var(--vi)', '--macd': 'var(--vid)' } as React.CSSProperties} onClick={() => navigate('/relatorios')}>
          ...
          <div className="mval money">{fmtCur(dash.faturamentoConcluido)}</div>
